...
/// <reference types="node" />
/// <reference types="node" />
import { BodyResponseCallback, DecorateRequestOptions, GetConfig, MetadataCallback, ServiceObject, SetMetadataResponse } from '@google-cloud/storage/build/src/nodejs-common';
import * as resumableUpload from '@google-cloud/storage/build/src/resumable-upload';
...
import { Acl, AclMetadata } from '@google-cloud/storage/build/src/acl';
import { GetSignedUrlResponse, GetSignedUrlCallback, URLSigner, Query } from '@google-cloud/storage/build/src/signer';
import { Duplexify } from '@google-cloud/storage/build/src/nodejs-common/util';
import { CRC32CValidatorGenerator } from '@google-cloud/storage/build/src/crc32c';
import { URL } from 'url';
import { BaseMetadata, DeleteCallback, DeleteOptions, RequestResponse, SetMetadataOptions } from '@google-cloud/storage/build/src/nodejs-common/service-object';
